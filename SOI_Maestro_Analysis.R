...
# I am defining the themes and color palettes that I will use in the plots
...
# Here you can put the path where you have your raw measurements. 
# The measurements should be .Spe files from MAESTRO (ORTEC). 

setwd("C:/Users/missi/OneDrive/Documents/Microdosimetry/14March2024_measurements")

# Here you can put a first cut (noise threshold) that you want to avoid in the analysis

cut <- 22

# df is the dataframe of the file you want to analyze. Then I read the file,
# skipping lines that containes different information that I don't use. 
# I will use the counts, the row line is the ADC channel. 
# I will also use the time information in the file.
...
# Now I am plotting the file similarly to a yd(y) distribution, but in ADC channels

count$count2 <- count$count*count$channel^2

count$Type <- "15nA"

# same but for file number 2
...
########## Plot of all measurements together #############
